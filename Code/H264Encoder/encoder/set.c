...
void x264_sei_dec_ref_pic_marking_write( x264_t *h, bs_t *s )
{
	...
	// SRG FIX ME TOO MANY PARAMETES!?
	// This is not called and would only ne called for blu-ray and with b-byrimid turn on to strict (we have b-pyrmid turned off by default for blu-ray)
