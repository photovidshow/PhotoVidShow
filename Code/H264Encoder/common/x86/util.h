...
#define x264_median_mv x264_median_mv_mmxext
void inline x264_median_mv_mmxext( int16_t *dst, int16_t *a, int16_t *b, int16_t *c )
{
...
#define x264_predictor_difference x264_predictor_difference_mmxext
int inline x264_predictor_difference_mmxext( int16_t (*mvc)[2], intptr_t i_mvc )
{
	static const uint64_t pw_1 = 0x0001000100010001ULL;
	__asm {
		mov     eax, i_mvc
...
#define x264_cabac_mvd_sum x264_cabac_mvd_sum_mmxext
uint16_t inline x264_cabac_mvd_sum_mmxext(uint8_t *mvdleft, uint8_t *mvdtop)
{
	static const __m64 pb_2    = {0x0202020202020202ULL};
	static const __m64 pb_32   = {0x2020202020202020ULL};
	__m64 mm0, mm1, mm2;
	mm0 = _mm_add_pi8(_mm_cvtsi32_si64(*(int32_t*)mvdleft),_mm_cvtsi32_si64(*(int32_t*)mvdtop));
	mm1 = mm0;
