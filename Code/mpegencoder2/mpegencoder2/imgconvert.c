...
static __inline int C_JPEG_TO_CCIR(int y) {
...
static __inline unsigned char gif_clut_index(uint8_t r, uint8_t g, uint8_t b)
{
...
static __inline unsigned int bitcopy_n(unsigned int a, int n)
{
    int mask;
    mask = (1 << n) - 1;
...
static __inline int is_yuv_planar(PixFmtInfo *ps)
{
