...
static int __inline get_mb_score(MpegEncContext * s, int mx, int my, int src_index,
                               int ref_index)
{
...
static __inline int small_diamond_search(MpegEncContext * s, int *best, int dmin,
...
static __inline int diamond_search(MpegEncContext * s, int *best, int dmin,
                                       int src_index, int ref_index, int const penalty_factor,
                                       int size, int h, int flags){
    MotionEstContext * const c= &s->me;
    if(c->dia_size==-1)
...
static __inline int epzs_motion_search_internal(MpegEncContext * s, int *mx_ptr, int *my_ptr,
...
static __inline int epzs_motion_search(MpegEncContext * s, int *mx_ptr, int *my_ptr,
                             int P[10][2], int src_index, int ref_index, int16_t (*last_mv)[2], 
                             int ref_mv_scale)
{
    MotionEstContext * const c= &s->me;
