...
// {38c348d4-de98-4d44-916a-158d184a3ace}
static const GUID CLSID_WavDest =
{ 0x38c348d4, 0xde98, 0x4d44,{ 0x91, 0x6a, 0x15, 0x8d, 0x18, 0x4a, 0x3a, 0xce } };


const AMOVIESETUP_FILTER sudWavDest =
{
	&CLSID_WavDest,           // clsID
	L"PVS WAV Dest",           // strName
...
CFactoryTemplate g_Templates[] = {
	{ L"PVS WAV Dest", &CLSID_WavDest, CWavDestFilter::CreateInstance, NULL, &sudWavDest },
};
...
CWavDestFilter::CWavDestFilter(LPUNKNOWN pUnk, HRESULT *phr) :
	CTransformFilter(NAME("PVS WavDest filter"), pUnk, CLSID_WavDest),
	m_cbWavData(0),
	m_cbHeader(0)
{
	ASSERT(m_pOutput == 0);
...
CWavDestOutputPin::CWavDestOutputPin(CTransformFilter *pFilter, HRESULT * phr) :
	CTransformOutputPin(NAME("PVS WavDest output pin"), pFilter, phr, L"Out")
{
	// Empty
}
