...
static  struct vm_statement *statement_new()
{
...
static  struct vm_statement *statement_expression(struct vm_statement *v1,int op,struct vm_statement *v2)
{
...
static  struct vm_statement *statement_setop(int reg,int op,struct vm_statement *vp)
{
