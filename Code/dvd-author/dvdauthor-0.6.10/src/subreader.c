...
sub_data* sub_read_file (char *filename, float fps) {
    ...
    struct subreader sr[]=
    {
	    { sub_read_line_microdvd, NULL, "aewfwef" },
	    { sub_read_line_subrip, NULL, "fbfdgdf" },
	    { sub_read_line_subviewer, NULL, "ewfwef" },
	    { sub_read_line_sami, NULL, "dsfsdf" },
	    { sub_read_line_vplayer, NULL, "dgfdsfd" },
	    { sub_read_line_rt, NULL, "sdfsdf" },
	    { sub_read_line_ssa, sub_pp_ssa, "bfbfgb" },
	    { sub_read_line_dunnowhat, NULL, "thrth" },
	    { sub_read_line_mpsub, NULL, "fdgdfgreg" },
	    { sub_read_line_aqt, NULL, "dfgdfg" },
	    { sub_read_line_subviewer2, NULL, "regerg" },
	    { sub_read_line_subrip09, NULL, "rgerg" },
	    { sub_read_line_jacosub, NULL, "efwefwef" }
    };
