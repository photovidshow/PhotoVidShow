...
extern int createdvdfiles(char* my_xml_buffer, char* output_name);
extern int subuxmain(char* my_xml_buffer,
					 char* input_name,
					 char* output_name, 
					 char* srg_raw_main_image,
					 char* srg_raw_highlight_image, 
					 char* srg_raw_select_image, 
					 int the_mode,
					 int width,
					 int height,
					 struct centre_button_buttons* return_list);
