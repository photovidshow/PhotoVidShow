...
#include <stdlib.h>
#include <stdio.h>
//static const char RCSID[]="$Id: //depot/dvdauthor/src/subrender.c#9 $";
...
static  void vo_draw_alpha_rgb24(int w,int h, unsigned char* src, unsigned char *srca, int srcstride, unsigned char* dstbase,int dststride){
    int y,i;
    for(y=0;y<h;y++){
