...
unsigned int    which_streams)
{
  ...
  {
    istream_v = CreateFile(VideoFilename, GENERIC_READ, FILE_SHARE_READ, NULL,
  ...
  {
    istream_a = CreateFile(AudioFilename, GENERIC_READ, FILE_SHARE_READ, NULL,
		                   OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
  ...
  {
    istream_a1 = CreateFile(Audio1Filename, GENERIC_READ, FILE_SHARE_READ, NULL,
		                   OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
...
//    video_rate = (int)ceil((double)video_rate * 1.25);
  ...
  if (which_streams & STREAMS_AUDIO)
  {
    if (audio_info->layer)
    {                                /* MPEG */
	 // DebugOutbutMessageToFile("multiplexing audio as mpeg\n");
    ...
    {                   /* AC3 */
    //  DebugOutbutMessageToFile("multiplexing audio as ac3\n");
